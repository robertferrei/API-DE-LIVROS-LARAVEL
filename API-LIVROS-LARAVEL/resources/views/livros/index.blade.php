    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <th>{{$livro->valor}}</th>
                <th>
                    <a href="{{ route('livros-edit',['id'=>$livro->id])}}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
